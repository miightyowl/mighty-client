...
MACRO_CONFIG_INT(ClMClientFrozenWeaponHammerOnly, cl_mclient_frozen_weapon_hammer_only, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "M-Client: only recolor a frozen tee's weapon while it tries to interact if the weapon is the hammer")
