...
MACRO_CONFIG_INT(ClMClientTextBrightness, cl_mclient_text_brightness, 100, 30, 100, CFGFLAG_CLIENT | CFGFLAG_SAVE, "M-Client: brightness of default white UI text in percent")
MACRO_CONFIG_INT(ClMClientMenuAnimation, cl_mclient_menu_animation, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "M-Client: animate drifting light streaks behind the menu background")
MACRO_CONFIG_INT(ClMClientMenuCursorSize, cl_mclient_menu_cursor_size, 100, 50, 300, CFGFLAG_CLIENT | CFGFLAG_SAVE, "M-Client: size of the menu mouse cursor in percent")
MACRO_CONFIG_INT(ClMClientIngameCursorSize, cl_mclient_ingame_cursor_size, 100, 50, 300, CFGFLAG_CLIENT | CFGFLAG_SAVE, "M-Client: size of the ingame weapon cursor in percent")
...
MACRO_CONFIG_INT(ClMClientFrozenWeapon, cl_mclient_frozen_weapon, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "M-Client: keep showing the weapon of frozen tees instead of hiding it, and recolor it while they hold fire")
MACRO_CONFIG_COL(ClMClientFrozenHammerColor, cl_mclient_frozen_hammer_color, 5963648, CFGFLAG_CLIENT | CFGFLAG_SAVE, "M-Client: color a frozen tee's weapon is recolored with while it tries to interact")
MACRO_CONFIG_INT(ClMClientFrozenHammerColorAlpha, cl_mclient_frozen_hammer_color_alpha, 100, 10, 100, CFGFLAG_CLIENT | CFGFLAG_SAVE, "M-Client: how strongly the frozen weapon color is applied")
MACRO_CONFIG_INT(ClMClientFrozenWeaponInteractOnly, cl_mclient_frozen_weapon_interact_only, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "M-Client: only show a frozen tee's weapon while it tries to interact, hide it otherwise")
MACRO_CONFIG_INT(ClMClientFrozenWeaponHammerOnly, cl_mclient_frozen_weapon_hammer_only, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "M-Client: only count a frozen tee as interacting while it holds the hammer")
MACRO_CONFIG_INT(ClMClientFrozenWeaponHideSelf, cl_mclient_frozen_weapon_hide_self, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "M-Client: hide the weapon on your own tee and dummy while frozen")
MACRO_CONFIG_INT(ClMClientFrozenWeaponNotSelf, cl_mclient_frozen_weapon_not_self, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "M-Client: do not recolor the weapon on your own tee and dummy while frozen")
...
MACRO_CONFIG_INT(ClMClientPetTeeOthers, cl_mclient_pet_tee_others, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "M-Client: show the companion tees of other M-Client players")
MACRO_CONFIG_INT(ClMClientPetTeeUseCustomColor, cl_mclient_pet_tee_use_custom_color, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "M-Client: use custom colors for the companion tee")
MACRO_CONFIG_COL(ClMClientPetTeeColorBody, cl_mclient_pet_tee_color_body, 65408, CFGFLAG_CLIENT | CFGFLAG_SAVE | CFGFLAG_COLLIGHT, "M-Client: companion tee body color")
MACRO_CONFIG_COL(ClMClientPetTeeColorFeet, cl_mclient_pet_tee_color_feet, 65408, CFGFLAG_CLIENT | CFGFLAG_SAVE | CFGFLAG_COLLIGHT, "M-Client: companion tee feet color")
MACRO_CONFIG_INT(ClMClientDummyPetTee, cl_mclient_dummy_pet_tee, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "M-Client: show a companion tee that floats near the dummy")
MACRO_CONFIG_STR(ClMClientDummyPetTeeSkin, cl_mclient_dummy_pet_tee_skin, 24, "default", CFGFLAG_CLIENT | CFGFLAG_SAVE | CFGFLAG_INSENSITIVE, "M-Client: skin used for the dummy's companion tee")
MACRO_CONFIG_INT(ClMClientDummyPetTeeSize, cl_mclient_dummy_pet_tee_size, 60, 10, 500, CFGFLAG_CLIENT | CFGFLAG_SAVE, "M-Client: size of the dummy's companion tee as a percentage of a normal player")
MACRO_CONFIG_INT(ClMClientDummyPetTeeAlpha, cl_mclient_dummy_pet_tee_alpha, 90, 10, 100, CFGFLAG_CLIENT | CFGFLAG_SAVE, "M-Client: opacity of the dummy's companion tee")
MACRO_CONFIG_INT(ClMClientDummyPetTeeUseCustomColor, cl_mclient_dummy_pet_tee_use_custom_color, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "M-Client: use custom colors for the dummy's companion tee")
MACRO_CONFIG_COL(ClMClientDummyPetTeeColorBody, cl_mclient_dummy_pet_tee_color_body, 65408, CFGFLAG_CLIENT | CFGFLAG_SAVE | CFGFLAG_COLLIGHT, "M-Client: dummy companion tee body color")
MACRO_CONFIG_COL(ClMClientDummyPetTeeColorFeet, cl_mclient_dummy_pet_tee_color_feet, 65408, CFGFLAG_CLIENT | CFGFLAG_SAVE | CFGFLAG_COLLIGHT, "M-Client: dummy companion tee feet color")
...
MACRO_CONFIG_INT(ClMClientUserDetection, cl_mclient_user_detection, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "M-Client: temporarily mark unused color bits after joining, so other M-Client players are detected automatically")
...
MACRO_CONFIG_INT(ClMClientHideProtocolWhispers, cl_mclient_hide_protocol_whispers, 1, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "M-Client: hide protocol whispers used for communication")
...
MACRO_CONFIG_INT(ClMClientBindWheelPages, cl_mclient_bindwheel_pages, 1, 1, 16, CFGFLAG_CLIENT | CFGFLAG_SAVE, "M-Client: number of bind wheel pages, switch with the mouse wheel (1-16)")
MACRO_CONFIG_INT(ClMClientBindWheelScrollInvert, cl_mclient_bindwheel_scroll_invert, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "M-Client: invert the mouse wheel direction that switches bind wheel pages")
MACRO_CONFIG_INT(ClMClientBindWheelPageNumberSize, cl_mclient_bindwheel_page_number_size, 22, 0, 60, CFGFLAG_CLIENT | CFGFLAG_SAVE, "M-Client: font size of the page number in the middle of the bind wheel")
MACRO_CONFIG_INT(ClMClientBindWheelPageNumberAlpha, cl_mclient_bindwheel_page_number_alpha, 50, 0, 100, CFGFLAG_CLIENT | CFGFLAG_SAVE, "M-Client: opacity of the page number in the middle of the bind wheel")
MACRO_CONFIG_INT(ClMClientBindWheelAlpha, cl_mclient_bindwheel_alpha, 10, 0, 100, CFGFLAG_CLIENT | CFGFLAG_SAVE, "M-Client: background opacity of the bind wheel")
MACRO_CONFIG_INT(ClMClientBindWheelSize, cl_mclient_bindwheel_size, 80, 50, 120, CFGFLAG_CLIENT | CFGFLAG_SAVE, "M-Client: size of the bind wheel circle in percent")
MACRO_CONFIG_INT(ClMClientBindWheelBoxWidth, cl_mclient_bindwheel_box_width, 80, 30, 160, CFGFLAG_CLIENT | CFGFLAG_SAVE, "M-Client: width of the bind wheel boxes")
MACRO_CONFIG_INT(ClMClientBindWheelBoxHeight, cl_mclient_bindwheel_box_height, 40, 24, 64, CFGFLAG_CLIENT | CFGFLAG_SAVE, "M-Client: height of the bind wheel boxes")
MACRO_CONFIG_COL(ClMClientBindWheelBoxColor, cl_mclient_bindwheel_box_color, 10518912, CFGFLAG_CLIENT | CFGFLAG_SAVE, "M-Client: color of the selected bind wheel box")
MACRO_CONFIG_INT(ClMClientBindWheelBoxAlpha, cl_mclient_bindwheel_box_alpha, 40, 0, 100, CFGFLAG_CLIENT | CFGFLAG_SAVE, "M-Client: opacity of the bind wheel boxes")
...
MACRO_CONFIG_STR(ClAssetCursor, cl_asset_cursor, 50, "default", CFGFLAG_SAVE | CFGFLAG_CLIENT, "The asset for the menu cursor")
...
MACRO_CONFIG_INT(ClChatTranslateShortWords, cl_chat_translate_short_words, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "M-Client: also translate very short words that are skipped by default, chat emotes stay untranslated")
