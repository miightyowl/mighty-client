...
MACRO_CONFIG_INT(ClMClientBindWheelSlots, cl_mclient_bindwheel_slots, 8, 4, 16, CFGFLAG_CLIENT | CFGFLAG_SAVE, "M-Client: number of slices on the bind wheel (4-16)")
...
MACRO_CONFIG_INT(ClMClientBindWheelSize, cl_mclient_bindwheel_size, 80, 50, 200, CFGFLAG_CLIENT | CFGFLAG_SAVE, "M-Client: size of the bind wheel circle in percent")
MACRO_CONFIG_INT(ClMClientBindWheelBoxWidth, cl_mclient_bindwheel_box_width, 80, 60, 160, CFGFLAG_CLIENT | CFGFLAG_SAVE, "M-Client: width of the bind wheel boxes")
